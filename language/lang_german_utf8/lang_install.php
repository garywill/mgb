<?php
	...
	*/
	...
	$lang['error_1'] = "Deine PHP Version ist &auml;lter als die erforderliche. Eine Aktualisierung wird empfohlen.<br><br><b>Setze die Variable ''".chr(36)."ignore_warnings'' in Zeile 58 der install.php auf '1', um trotz der Warnungen fortzufahren.</b>";
	$lang['error_2'] = "Deine MySQL Version ist &auml;lter als die erforderliche. Eine Aktualisierung wird empfohlen.<br><br><b>Setze die Variable ''".chr(36)."ignore_warnings'' in Zeile 58 der install.php auf '1', um trotz der Warnungen fortzufahren.</b>";
	...
	$lang['error_4'] = "Die Konfiguration ist nicht schreibbar. Setze mit einem FTP Programm die Rechte (chmod) des Ordners ''includes'' auf 755.";
