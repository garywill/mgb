...
<table class="settings" summary="settings" cellspacing="0" cellpadding="2">
	...
	<tr>
		...
		<select class="option" name="entries_order" size="1">
			...
			<option{SELECTED_ENTRIES_ORDER_6} value="msn">{LANG_MSN}</option>
			<option{SELECTED_ENTRIES_ORDER_7} value="hp">{LANG_HP}</option>
			<option{SELECTED_ENTRIES_ORDER_8} value="message">{LANG_MESSAGE}</option>
			<option{SELECTED_ENTRIES_ORDER_9} value="comment">{LANG_COMMENT}</option>
			<option{SELECTED_ENTRIES_ORDER_10} value="timestamp">{LANG_TIMESTAMP}</option>
		</select>
		</td>
	</tr>
	<tr>
